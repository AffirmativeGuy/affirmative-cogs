...
class cop(commands.Cog):
   ...
   # async def cog_unload(self) -> None:
    ...
    async def credits(self, ctx):
        ...
        embed.add_field(inline=False, name = 'Cogs and their creators(Thanks to those awesome people for their work :P)', value = '**[aaa3a-cogs](https://github.com/AAA3A-AAA3A/AAA3A-cogs): \n[ad-cog](https://github.com/aikaterna/gobcog.git): \n[adrian](https://github.com/designbyadrian/CogsByAdrian.git): \n[blizz-cogs](https://git.purplepanda.cc/blizz/blizz-cogs): \n[crab-cogs](https://github.com/orchidalloy/crab-cogs): \n[flare-cogs](https://github.com/flaree/Flare-Cogs): \n[fluffycogs](https://github.com/zephyrkul/FluffyCogs): \n[jojocogs](https://github.com/Just-Jojo/JojoCogs): \n[jumperplugins](https://github.com/Redjumpman/Jumper-Plugins): \n[laggrons-dumb-cogs](https://github.com/retke/Laggrons-Dumb-Cogs): \n[lui-cogs-v3](https://github.com/Injabie3/lui-cogs-v3): \n[maxcogs](https://github.com/ltzmax/maxcogs): \n**')
        embed.add_field(inline=False, name = ' ', value = '**[affirmative-cogs](https://github.com/AffirmativeGuy/affirmative-cogs): \n[npc-cogs](https://github.com/npc203/npc-cogs): \n[pcxcogs](https://github.com/PhasecoreX/PCXCogs): \n[seina-cogs](https://github.com/japandotorg/Seina-Cogs/): \n[sravan](https://github.com/sravan1946/sravan-cogs): \n[toxic-cogs](https://github.com/NeuroAssassin/Toxic-Cogs): \n[Trusty-cogs](https://github.com/TrustyJAID/Trusty-cogs/): \n[vrt-cogs](https://github.com/vertyco/vrt-cogs): \n[yamicogs](https://github.com/yamikaitou/YamiCogs): \n**')
        await ctx.send(embed=embed)
    @commands.command()
